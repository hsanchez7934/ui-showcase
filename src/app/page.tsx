		...
		<main className="min-h-dvh bg-white dark:bg-black ">
			...
			<section id="featured" className="mx-auto max-w-6xl px-6 py-10 sm:py-14">
				<div className="mb-6 flex items-end justify-between">
					...
					<Link
						href="#categories"
						className="hidden rounded-lg border border-slate-200 px-3 py-1.5 text-sm text-slate-700 dark:text-slate-300 transition hover:bg-slate-50 sm:inline-flex"
					>
						Browse by category
					</Link>
				</div>
			...
			<section id="about" className="mx-auto max-w-6xl px-6 py-10 sm:py-16">
				<div className="rounded-3xl border border-slate-200 bg-slate-50/60 dark:bg-slate-900 p-6 sm:p-10">
					<div className="grid grid-cols-1 items-start gap-6 sm:grid-cols-3">
						<div className="sm:col-span-2">
							...
							<p className="mt-3 max-w-3xl text-slate-700 dark:text-slate-400">
								This is a curated, growing library of UI components and views I build to demonstrate
								front‑end craftsmanship: reusable patterns, strong UX, accessibility, and
								performance-minded code. Each page includes an isolated demo and a breakdown of the
								component’s responsibilities and design decisions.
							</p>
						</div>
			...
			<footer className="mx-auto max-w-6xl px-6 pb-12">
				<div className="flex flex-col items-center justify-between gap-3 rounded-2xl border border-slate-200 bg-white dark:bg-slate-900 p-4 sm:flex-row">
